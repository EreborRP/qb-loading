...
const load = Vue.createApp({
  setup () {
    return {
      CarouselText1: 'Welcome to Erebor RP, where your gameplay pays you.',
      CarouselSubText1: 'Running on Elrond Network blockchain.',
      CarouselText2: 'Be nice to others and do not brake the RULES.',
      CarouselSubText2: 'Otherwise you will get banned.',
      CarouselText3: 'We do not accept any hacking scripts.',
      CarouselSubText3: 'You will get banned instantly. Without possibility to get unban.',
      CarouselText4: 'For additional support please join our community at discord.gg/qbcore',
      CarouselSubText4: 'Or reach me #zVoxty',
